...
public class CircularProgress extends View {
    ...
    private void initColor(Context context) {
        ...
        mColors[0] = ColorUtil.getColorPrimary(context);
        mColors[1] = ColorUtil.getColorPrimary(context);
        mColors[2] = ColorUtil.getColorPrimary(context);
        mColors[3] = ColorUtil.getColorPrimary(context);
    }
